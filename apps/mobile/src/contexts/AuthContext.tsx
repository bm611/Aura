...
import { getSupabase } from '@folio/shared'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const { data: { subscription } } = supabase.auth.onAuthStateChange((_event: unknown, newSession: import('@supabase/supabase-js').Session | null) => {
